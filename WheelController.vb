...
#Region "Lose a Turn"
    Public Shared Sub LoseATurn()
        If previousValue <> "Bankrupt" Then
...
#End Region
            ...
            Else
                ...
                wheelWedges.Add(70, "500")
            End If
            wheelWedges.Add(71, "3500")
            wheelWedges.Add(72, "3500")
        ElseIf round = PuzzleType.R3 Then
            wheelWedges.Clear()
            wheelWedges.Add(1, "3500")
            wheelWedges.Add(2, "Bankrupt")
        ...
        ElseIf round = PuzzleType.BR Then
            ...
            For i As Integer = 1 To 48 Step 2
